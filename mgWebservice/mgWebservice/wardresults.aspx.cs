...
namespace mgWebservice
{
    public partial class wardresults : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int intElection = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings.Get("election").ToString());
            ...
            XmlNode xnWards = modernGov.GetElectionResults(intElection);
            ...
            if (WardList.Count > intStartNumber)
            {
            ...
            foreach (Ward Ward in WardList)
            {
                ...
                if (WardIndList.Count > 0)
                {

                    strContent += "<div class=\"col-sm-6\"><h2>" + WardIndList[0].ward + "</h2></div>";

                    if (Ward.numballotpapersissued != null && Ward.numballotpapersissued != 0)
                    {
